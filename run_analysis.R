#getting_and_cleaning_data_projectv1.R
...
# Then read the .txt files that hold the test data and training data
...
# write the data in an interesting order: by measurement, then activity, then who did the activity
